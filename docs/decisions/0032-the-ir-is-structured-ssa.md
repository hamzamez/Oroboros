...
begun**: the shared plan `ir/plan`, and JavaScript on it
([irstep3-2026-09-25](../../gauntlet/results/irstep3-2026-09-25.md)). **Realizes [ADR 0006](0006-ir-file-format.md)**, which
