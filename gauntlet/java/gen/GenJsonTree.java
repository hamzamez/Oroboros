...
public final class GenJsonTree {
	...
	public static long GenRun(long k) {
		...
		if ((k == 0)) {
			...
			t345 = (((nodes60[(int) 0] - 1) * 1000000) + ((r374 * 10) + nodes60[(int) 1]));
		} else {
			long t533;
			if ((k == 1)) {
				...
				t533 = (((nodes90[(int) 0] - 1) * 1000000) + ((r562 * 10) + nodes90[(int) 1]));
			} else {
				long t627;
				if ((k == 2)) {
					...
					t627 = (((nodes110[(int) 0] - 1) * 1000000) + ((r687 * 10) + nodes110[(int) 1]));
				}
				t533 = t627;
			}
			t345 = t533;
